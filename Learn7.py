...
class Learn():
    ...
    def _plot_graphs(self):
        self.f,self.ax = plt.subplots(len(self.transition['all']),3) # first col motion , second distance
    ...
    def _plot_final_graph(self):
        ...
        for count,T in enumerate(self.transition['all']):
            plt.sca(self.ax[count,2])
            ...
            self.ax[count,2].add_collection(collection)
